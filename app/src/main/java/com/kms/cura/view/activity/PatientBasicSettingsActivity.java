...
public class PatientBasicSettingsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        initToolbar();
        initBirthTextView();
        DataUtils.loadProfile(entity, (ImageView) findViewById(R.id.photo_profile));
        initEditText();
        initButtons();
        initSpinner();
    }
            ...
            AsyncTask<Object, Void, Void> task = new AsyncTask<Object, Void, Void>() {
                ...
                protected Void doInBackground(Object[] params) {
                    try {
                        ...
                        UserController.updatePatient(entityUpdated);
                    } catch (Exception e) {
                        exception = e;
                    }
                    return null;
    ...
    private PatientUserEntity getPatientUserEntity() throws ParseException {
        ...
        if (spnSex_settings.getSelectedItemPosition() == 0) {
            entityUpdated.setGender("M");
        } else {
            entityUpdated.setGender("F");
        }
        ...
        entityUpdated.setInsurance(insurances.get(spnInsurance_settings.getSelectedItemPosition()));
